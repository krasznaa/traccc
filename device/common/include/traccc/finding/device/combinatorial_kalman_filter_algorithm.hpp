...
class combinatorial_kalman_filter_algorithm
    ...
    struct apply_interaction_kernel_payload {
        ...
        /// The detector object
        const detector_buffer& det_data;
    ...
    virtual void sort_param_ids_by_keys(
        const vecmem::data::vector_view<const device::sort_key>& keys,
        vecmem::data::vector_view<unsigned int>& param_ids) const = 0;
    ...
    ///
    /// @param n_tips_total The total number of track tips
    /// @param payload The payload for the kernel
    ///
