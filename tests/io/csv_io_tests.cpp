...
TEST(io, csv_read_single_module)
{
    ...
    ASSERT_EQ(module.range0, expected_range0);
    auto expected_range1 = std::array<traccc::channel_id,2>{32u,880u};
    ASSERT_EQ(module.range1, expected_range1);
...
TEST(io, csv_read_two_modules)
{
    ...
    auto expected_range0 = std::array<traccc::channel_id,2>{123u,174u};
    ASSERT_EQ(first_module.range0, expected_range0);
    auto expected_range1 = std::array<traccc::channel_id,2>{32u,880u};
    ASSERT_EQ(first_module.range1, expected_range1);
    ...
    ASSERT_EQ(second_module.range0, expected_range0);
    expected_range1 = std::array<traccc::channel_id,2>{4u,98u};
    ASSERT_EQ(second_module.range1, expected_range1);
