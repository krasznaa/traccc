...
void fill_pattern(
    ...
    const traccc::scalar chi2, const std::vector<std::size_t>& pattern) {

    track_candidates.at(idx).chi2() = chi2;
...
TEST(AmbiguitySolverTests, GreedyResolverTest0) {
    ...
    trk_cands.resize(3u);
    fill_pattern(trk_cands, measurements, 0, 8.3f, {1, 3, 5, 11});
    fill_pattern(trk_cands, measurements, 1, 2.2f, {6, 7, 8, 9, 10, 12});
    fill_pattern(trk_cands, measurements, 2, 3.7f, {2, 4, 13});
...
TEST(AmbiguitySolverTests, GreedyResolverTest1) {
    ...
    trk_cands.resize(2u);
    fill_pattern(trk_cands, measurements, 0, 4.3f, {1, 3, 5, 11, 14, 16, 18});
    fill_pattern(trk_cands, measurements, 1, 1.2f, {3, 5, 6, 13});
...
TEST(AmbiguitySolverTests, GreedyResolverTest2) {
    ...
    trk_cands.resize(2u);
    fill_pattern(trk_cands, measurements, 0, 4.3f, {1, 3, 5, 11});
    fill_pattern(trk_cands, measurements, 1, 1.2f, {3, 5, 6, 13});
...
TEST(AmbiguitySolverTests, GreedyResolverTest3) {
    ...
    trk_cands.resize(6u);
    fill_pattern(trk_cands, measurements, 0, 5.3f, {1, 3, 5, 11});
    fill_pattern(trk_cands, measurements, 1, 2.4f, {2, 6});
    fill_pattern(trk_cands, measurements, 2, 2.5f, {3, 6, 12, 14, 19, 21});
    fill_pattern(trk_cands, measurements, 3, 13.3f, {2, 7, 11, 13, 16});
    fill_pattern(trk_cands, measurements, 4, 4.1f, {1, 7, 8});
    fill_pattern(trk_cands, measurements, 5, 1.1f, {1, 3, 11, 22});
...
TEST(AmbiguitySolverTests, GreedyResolverTest4) {
    ...
    for (std::size_t i = 0; i < n_tracks; i++) {
        ...
        // Fill the pattern
        fill_pattern(trk_cands, measurements, i, chi2, pattern);
    }
